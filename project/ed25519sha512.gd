class_name Ed25519Sha512
static func test():
	print("\n\n<== Testing Ed25519 with SHA512 ==>\n")
	
	var crypto = Ed25519SHA512.new()
	var key_generator = Ed25519SHA512Keypair.new()
	
	# 1. Test Key Generation
	print("1. Test Key Generation")
	var alice_keys = key_generator.generate()
	var bob_keys = key_generator.generate()
